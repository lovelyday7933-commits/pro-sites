...
cta:
  ...
  chapter: "1장 셋을 가르는 선"
---
리플사의 계약과 기관의 XRP ETF 보유만으로는 실제 XRP 수요가 확인됐다고 볼 수 없다. 전자는 회사 사업에 관한 소식이고 후자는 펀드 지분에 관한 기록이므로, 실제 자금 경로에 XRP가 들어갔는지는 별도 자료로 확인해야 한다. 이 글은 리플사, XRP Ledger, XRP와 펀드 지분을 가르는 질문 하나에 집중한다. 실제 자금 경로에 XRP가 들어갔는가.
